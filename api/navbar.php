...
<header class="nav-down">
  ...
  <ul id='dropdown-list' class='dropdown-content'>
    ...
    <li class="divider"></li>
    <li><a href="<?php echo url(); ?>/profile" class="black-text"><i class="material-icons black-text">person</i> Profile (WIP)</a></li>
    <li><a href="<?php echo url(); ?>/settings" class="black-text"><i class="material-icons black-text">settings</i> Settings (WIP)</a></li>
    <li class="divider"></li>
