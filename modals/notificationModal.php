<div id="notificationModal" class="modal bottom-sheet notificationModal">
  <div class="modal-content">
    ...
    <div class="card blue-grey darken-1 notifi">
      <div class="card-content white-text">
        ...
        <div class="row polls1"></div>

      </div>
      <div class="card-action">
        <a href="#" class="modal-action waves-effect waves-black btn-flat white-text accent-4 modal-close">Close</a>
        <a href="#" class="modal-action waves-effect waves-black btn-flat white-text green accent-4 1confirm-button" onclick="progressPoll(1,1)">Confirm</a>
      </div>
    </div>

    <div class="card blue-grey darken-1 notifi">
      <div class="card-content white-text">
        <span class="card-title qTitle2">Umfrage</span>

        <div class="row polls2"></div>
