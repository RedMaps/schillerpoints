...
<header>
  <div class='navbar-fixed'>
    <nav class="navbar">
      <div class="nav-wrapper green accent-4">
        <a href="<?php echo url(); ?>" class="brand-logo">&nbsp&nbspS-Points</a>
        ...
        <ul id="nav-mobile" class="right hide-on-med-and-down">
          ...
          <li><a id="dropdown" class="uName uname_drop dropdown-button" href="#!" data-activates="dropdown-list">Gast<i class="material-icons right">arrow_drop_down</i></a></li>
        </ul>
  ...
  <ul id="slide-out" class="side-nav slide-mobile blue-grey darken-2 white-text">
    <li><div class="userView white-text z-depth-2">
      ...
      <a href="#!user"></a>
      <a href="#!name"><span class="white-text name uNameMobile" id="uname">Gast</span></a>
      <a href="#!email"><span class="white-text email uMail" id="umail">gast@schillerpoints.de</span></a>
    </div></li>
